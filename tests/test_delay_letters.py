...
amqp.setup_delay_letter(exchange=test_config.DELAY_EXCHANGE, routing_key=test_config.DELAY_ROUTING_KEY, queue=config.RABBITMQ_QUEUE)
...
def test_delay_letter():
    ...
    try:
        amqp.basic_publish(exchange=test_config.DELAY_EXCHANGE,
